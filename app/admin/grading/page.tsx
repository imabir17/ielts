    ...
    <div className="flex h-screen bg-[var(--paper)]">
      ...
      <div className="flex-1 flex flex-col font-sans h-screen overflow-hidden">
        <header className="h-16 bg-white border-b border-[var(--line)] px-8 flex items-center justify-between shrink-0">
          <h1 className="font-display text-[20px] text-[var(--ink)] leading-tight">Writing Assessment Center</h1>
        </header>

        <main className="flex-1 overflow-y-auto p-8 max-w-7xl w-full mx-auto flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-2/3 flex flex-col">
            {selectedLog && selectedTest ? (
              ...
              <div className="panel p-10 flex-1 flex flex-col items-center justify-center text-center text-[var(--ink-soft)] bg-white/50 border-dashed">
